    ...
    <section className="text-gray-600 body-font">
      ...
      {/* <h1 className="title-font text-2xl font-bold text-gray-700 mb-6 text-center pb-8">Puerto Montt, Chile</h1> */}
        ...
        <div className="flex flex-column flex-wrap -m-4 h-1/3">
          ...
          <div className="h-full flex-1 rounded-xl shadow-cla-blue bg-gradient-to-r from-sky-100 to-sky-100 overflow-hidden">
         ...
         <Link href="/detail/[id]" as={`/detail/${producto.id}`}>
            ...
            <div className="p-6">
              ...
              <p className="truncate leading-relaxed mb-3">{ producto.description }</p>
